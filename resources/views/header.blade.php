...
--}}
  <nav class="navbar navbar-expand-lg navbar-light bg-light">
    <div class="container">
      <a class="navbar-brand" href="#" style="color: #f34780; font-weight: 600; font-size: 24px; ">MyShop</a>
      ...
      <div class="collapse navbar-collapse" id="navbarColor02">
        ...
        <ul class="navbar-nav col-lg-2 justify-content-center align-items-center">
            <li class="nav-item">
                <a class="nav-link" href="#">Cart <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" style="fill: #7b8ab8;transform: ;msFilter:;"><path d="M21 4H2v2h2.3l3.28 9a3 3 0 0 0 2.82 2H19v-2h-8.6a1 1 0 0 1-.94-.66L9 13h9.28a2 2 0 0 0 1.92-1.45L22 5.27A1 1 0 0 0 21.27 4 .84.84 0 0 0 21 4zm-2.75 7h-10L6.43 6h13.24z"></path><circle cx="10.5" cy="19.5" r="1.5"></circle><circle cx="16.5" cy="19.5" r="1.5"></circle></svg> (0)</a>
            </li>
        </ul>
